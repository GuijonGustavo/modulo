...
echo  "<div id=$tema>";
	echo  "<table id=$tema border=\"0\" width=\"1550\">";   
		echo  "<thead>";
			echo  "<tr>";
				echo  "<th width=\"152\">Titulo del Dato</th>";
				echo  "<th width=\"134\">Institución Responsable</th>";
				echo  "<th width=\"144\">Siglas de la Institución</th>";
				echo  "<th width=\"144\">Lugar de Publicación</th>";
				echo  "<th width=\"70\">Versión</th>";
				echo  "<th width=\"70\">Escala</th>";
				...
				echo  "<th width=\"126\">Informacion</th>";
				echo  "<th width=\"70\">Otros</th>";
				echo  "<th width=\"70\">Links</th>";
				echo  "<th></th>";
				echo  "<th width=\"50\">Autores</th>";
				echo  "<th></th>";
				echo  "</tr>";
			echo  "</thead>";
			echo  "<tbody >"; 
...
echo  "<div id=$tema>";
 echo  "<table width=\"1550\" id=$tema border=\"1\">";  
  echo  "<thead>";
   echo  "<tr>";
	 echo  "<th width=\"250\">Taxon</th>";
	 echo  "<th width=\"861\">Cita</th>";		
   echo  "</tr>";
  echo  "</thead>";
  echo  "<tbody>";
...
function tabla_tc($corto,$validt,$tema ,$cv_principal)
{
	...
	echo  "<div id=$tema>";
		echo  "<table id=$tema width=\"1050\">";
			echo  "<thead>";
				echo  "<tr>";
					echo  "<th width=\"100\">Título</th>";
					echo  "<th width=\"144\">Institución</th>";
					echo  "<th width=\"100\">Siglas</th>";
					echo  "<th width=\"144\">Lugar</th>";
					echo  "<th width=\"100\">Versión</th>";
					echo  "<th width=\"144\">Fecha</th>";
					echo  "<th width=\"100\">clave</th>";
					echo  "<th width=\"144\">Descripción</th>";
					echo  "<th>   </th>";
					echo  "<th>   </th>";
					echo  "<th>   </th>";
					echo  "<th width=\"169\">Autores</th>";
				echo  "</tr>";
			echo  "</thead>";
			echo  "<tbody>";
					$db = conectar();
