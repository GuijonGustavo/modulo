...
#                fechaDp.text = "Distribución potencial ("+autores_query+". "+fecha[2]+")"
        ...
        mxd.saveACopy(r'C:\\Users\\CPR\\Desktop\\\\\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd, r'C:\\Users\\CPR\\Desktop\\\\\\png\\'+filename+'.png', resolution = 300)
...
#        symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_sr.lyr')
        ...
        mxd_P.saveACopy(r'C:\\Users\\CPR\\Desktop\\\\\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd_P, r'C:\\Users\\CPR\\Desktop\\\\\\png\\'+filename+'.png', resolution = 300)
