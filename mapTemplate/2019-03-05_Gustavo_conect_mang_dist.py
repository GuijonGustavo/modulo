...
lista_shapes = os.listdir(r'C:\\Users\\CPR\\Desktop\\plantilla\\shp\\shp')
...
#Cita para sitios de recolecta
    ...
    newlayer1 = arcpy.mapping.Layer(r'C:\\Users\\CPR\\Desktop\\plantilla\\shp\\'+shapefile+'')





    desc = arcpy.Describe(r'C:\\Users\\CPR\\Desktop\\plantilla\\shp\\'+shapefile+'')
    ...
    if desc.shapeType == "Polygon":
        ...
        symbologyLayer = (r'C:\\Users\\CPR\\Desktop\\plantilla\\simb\\'+filename+'.lyr')
...
#            symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_dp.lyr')
        ...
        mxd.saveACopy(r'C:\\Users\\CPR\\Desktop\\plantilla\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd, r'C:\\Users\\CPR\\Desktop\\plantilla\\png\\'+filename+'.png', resolution = 300)
...
#        symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_sr.lyr')
        ...
        mxd_P.saveACopy(r'C:\\Users\\CPR\\Desktop\\plantilla\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd_P, r'C:\\Users\\CPR\\Desktop\\plantilla\\png\\'+filename+'.png', resolution = 300)
