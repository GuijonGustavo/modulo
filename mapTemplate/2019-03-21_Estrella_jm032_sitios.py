...
conn = pg.connect(dbname='sitios_jm032', user='postgres', passwd='sig123456', host='200.12.166.29')
...
lista_shapes = os.listdir(r'T:\\jm\\jm032\\sitios\\shp')
...
#intenta
    try:
        ...
        im = Image.open(r'T:\\jm\\jm032\\\img\\'+nombreImg+'.JPG')
...
#Cita para sitios de recolecta
    ...
    newlayer1 = arcpy.mapping.Layer(r'T:\\jm\\jm032\\sitios\\'+shapefile+'')





    desc = arcpy.Describe(r'T:\\jm\\jm032\\sitios\\'+shapefile+'')
...
#            symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_dp.lyr')
        ...
        try:
            ...
            for img in arcpy.mapping.ListLayoutElements(mxd, "PICTURE_ELEMENT"):
                ...
                if img.name == "noHayImagen":
                    ...
                    img.sourceImage = r'T:\\jm\\jm032\\img\\'+nombreImg+'.JPG'
        ...
        mxd.saveACopy(r'C:\\Users\\ecruz\\Desktop\\jm032\\sitios\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd, r'C:\\Users\\ecruz\\Desktop\\jm032\\sitios\\png\\'+filename+'.png', resolution = 300)
...
#        symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_sr.lyr')
        ...
        mxd_P.saveACopy(r'C:\\Users\\ecruz\\Desktop\\jm032\\sitios\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd_P, r'C:\\Users\\ecruz\\Desktop\\jm032\\sitios\\png\\'+filename+'.png', resolution = 300)
