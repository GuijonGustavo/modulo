...
conn = pg.connect(dbname='dist_jm032', user='postgres', passwd='sig123456', host='200.12.166.29')
...
lista_shapes = os.listdir(r'T:\\jm\\jm032\\dist\\shp')
...
#Cita para sitios de recolecta
    ...
    newlayer1 = arcpy.mapping.Layer(r'T:\\jm\\jm032\\dist\\'+shapefile+'')





    desc = arcpy.Describe(r'T:\\jm\\jm032\\dist\\'+shapefile+'')
...
#            symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_dp.lyr')
        ...
        mxd.saveACopy(r'C:\\Users\\oherrera\\Desktop\\jm032\\dist\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd, r'C:\\Users\\oherrera\\Desktop\\jm032\\dist\\png\\'+filename+'.png', resolution = 300)
...
#        symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_sr.lyr')
        ...
        mxd_P.saveACopy(r'C:\\Users\\oherrera\\Desktop\\jm032\\dist\\mxd\\'+filename+'.mxd')



        arcpy.mapping.ExportToPNG(mxd_P, r'C:\\Users\\oherrera\\Desktop\\jm032\\dist\\png\\'+filename+'.png', resolution = 300)
