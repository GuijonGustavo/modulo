...
conn = pg.connect(dbname='dist_conect_mang', user='postgres', passwd='sig123456', host='200.12.166.29')

###########Aqui va la lista de shapes#################3


lista_shapes = os.listdir(r'T:\\jm\\conect_mang\\dist\\shp')
lista_shapes.sort()
...
for shapefile in lista_shapes: #si se intenta un shape en particular se anade un rango lista_shapes[45:46]
    ...
    try:
        im = Image.open(r'T:\\jm\\conect_mang\\\img\\'+nombreImg+'.JPG')
        w,h = im.size
    except:
        pass
...
#Cita para sitios de recolecta
    ...
    newlayer1 = arcpy.mapping.Layer(r'T:\\jm\\conect_mang\\dist\\'+shapefile+'')




    desc = arcpy.Describe(r'T:\\jm\\conect_mang\\dist\\'+shapefile+'')
...
#            symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_dp.lyr')
        ...
        try:
            for img in arcpy.mapping.ListLayoutElements(mxd, "PICTURE_ELEMENT"):
                if img.name == "noHayImagen":
                    ...
                    img.sourceImage = r'T:\\jm\\conect_mang\\img\\'+nombreImg+'.JPG'
        ...
        mxd.saveACopy(r'C:\\Users\\vbenitez\\Desktop\\conect_mang\\dist\\mxd\\'+filename+'.mxd')
        ...
        arcpy.mapping.ExportToPNG(mxd, r'C:\\Users\\vbenitez\\Desktop\\conect_mang\\dist\\png\\'+filename+'.png', resolution = 300)
...
#        symbologyLayer = (r'J:\\USUARIOS\\SISTEM\\GMAGALLANES\\template\\base\\color_sr.lyr')
        ...
        mxd_P.saveACopy(r'C:\\Users\\vbenitez\\Desktop\\conect_mang\\dist\\mxd\\'+filename+'.mxd')
        ...
        arcpy.mapping.ExportToPNG(mxd_P, r'C:\\Users\\vbenitez\\Desktop\\conect_mang\\dist\\png\\'+filename+'.png', resolution = 300)
