...
else
{
	...
	require('php-shapefile/src/ShapeFileAutoloader.php');
	require('php-shapefile/src/ShapeFileException.php');
	require('php-shapefile/src/ShapeFile.php');
...
<script src="ColorPicker2.js"></script>
<script>
...
<form>                                                  
                                       <p class="txtN1">Estilo </p>
</form>




<?php include("shpAttr.php");?>
<!-- <form>
<table border="1">
<tr>
	<td>
	<input type="text" name="color" size="20" value=""> <a href="#" onClick="cp.selectionar(document.forms[0].color,'pick');return false;" name="pick" id="pick">Pick</a>
	</td>
</tr>
</table>
<br>
